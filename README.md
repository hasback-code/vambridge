...
**Tip:** You can create a Windows shortcut to the `.exe`, right-click it, select **Properties**, and add ` -d` to the end of the **Target** field to always launch in debug mode.
---
